...
export default function Index() {
    ...
    */
    ...
    // i remove this attribute from Hash links as it caused an error activeStyle={{color:'#007bff'}}
            ...
            <Nav show={Navposition} position={position}>
                <Nav_container>
                    ...
                    <Nav_links_list right={mobileNavPosition} id='nav_list'>
                        <Nav_links_items><NavHashLink smooth to='/#top'  style={{color:'white'}}  activeClassName='active'>Home</NavHashLink></Nav_links_items>
                        <Nav_links_items><NavHashLink smooth to='/#latest' style={{color:'white'}} ><span ref={latest}>Latest</span></NavHashLink></Nav_links_items>
                        <Nav_links_items><NavHashLink smooth to='/#Offer' style={{color:'white'}} ><span ref={offers}>Offers</span></NavHashLink></Nav_links_items>
                        <Nav_links_items><NavHashLink smooth to='/#Pan' style={{color:'white'}} ><span ref={pan}>Pan</span></NavHashLink></Nav_links_items>
                        <Nav_links_items><NavHashLink smooth to='/#Knife' style={{color:'white'}} ><span ref={knife}><i className='fa fa-cutlery'  style={{marginRight:'4px'}}></i></span></NavHashLink></Nav_links_items>
                        <Nav_links_items><NavHashLink smooth to='/#Spoon' style={{color:'white'}} ><span ref={spoon}><i className='fa fa-spoon'  style={{marginRight:'4px'}}></i></span></NavHashLink></Nav_links_items>
                        <Nav_links_items><NavHashLink smooth to='/#contact' style={{color:'white'}}  ><span ref={contact}>Contact</span></NavHashLink></Nav_links_items>
                        <Nav_links_items><Link  to='/cart' style={{color:'white'}}  ><i className='fas fa-shopping-cart'></i><span className='icon_number'>{icon_number}</span></Link></Nav_links_items>
                    </Nav_links_list>
